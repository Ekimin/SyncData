...
public class PersonDao {
    ...
    //根据id查找数据
    public List<PersonModel> getResultByIname(String iname){
        List<PersonModel> entModelList = new LinkedList<PersonModel>();
        Connection conn2 = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        String checkSql = "select regdate,casecode from cb_lostfaith_person where iname = ?";
